%% Example script: running MCMC chains serially
% This example illustrates how to call JAGS and run a number of MCMC chains serially
%
%%% Model definition
...
rng( 1 );
for i=1:nchains
    S.theta = rand; % An Initial Value for the Success Rate
